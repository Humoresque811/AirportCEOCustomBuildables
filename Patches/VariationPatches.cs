...
class VariationPatches
{
    public static void Postfix(PlaceableFloor __instance, ref Variation[] __result)
    {
        ...
        {
            AirportCEOCustomBuildables.LogError($"Variation patch failed! {ExceptionUtils.ProccessException(ex)}");
        }
    }
}
...
{
    public static void Prefix(ObjectDescriptionPanelUI __instance, ref VariationPackage variationPackage, out int __state)
    {
...
{
    public static void Prefix(ObjectDescriptionPanelUI __instance, PlaceableObject currentPlaceableObject, ref VariationPackage variationPackage, bool isVariation, out int __state)
    {
